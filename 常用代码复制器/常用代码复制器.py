...
layout = [
    ...
    [sg.T('by:', font=('黑体', 12), text_color='red', size=48, justification='right'), sg.T('北极星光', font=('黑体', 12), text_color='red')],
    [sg.T('E-mail:', font=('黑体', 12), text_color='red', size=48, justification='right'), sg.T('light22@126.com', font=('黑体', 12), text_color='red')]
]
